                    ...
                    <div class="form-group"> 
                        ...
                        <div class="form-group"> 
                            ...
                            <select class="form-control @error('level') is-invalid @enderror" id="exampleInputlevel" name="level"> 
                                ...
                                <option value="apoteker" @if(old('level') 
                                == 'apoteker')selected @endif>Apoteker</option> 
                                <option value="gudang" @if(old('level') ==
                                'gudang')selected @endif>Gudang</option> 
                                <option value="kasir" @if(old('level') ==
                                'kasir')selected @endif>Kasir</option> 
