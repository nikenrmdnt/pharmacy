        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="form-group"> 
                        ...
                        placeholder="Nama distributor" name="nama_distributor" value="{{$distributor->nama_distributor ?? old('nama_distributor')}}"> 
                    ...
                    <div class="form-group"> 
                        <label for="alamat">Alamat</label> 
                            ...
                            placeholder="Masukkan Alamat" name="alamat" value="{{$distributor->alamat ?? old('alamat')}}"> 
                        ...
                        <div class="form-group"> 
                            ...
                            placeholder="08xxx" name="notelepon" value="{{$distributor->notelepon ?? old('notelepon')}}"> 
