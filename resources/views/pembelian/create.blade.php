            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="nonota_beli">Nota Pembelian</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control 
                            @error('tgl_beli') is-invalid @enderror" id="tgl_beli" readonly placeholder="Masukkan Tanggal" name="tgl_beli" value="{{date('Y-m-d H:i:s') ?? old('tgl_beli')}}">
