            ...
            <div class="card"> 
                <div class="card-body"> 
                    ...
                    <div class="form-group"> 
                            <label
                            for="id_pembelian">Nota Pembelian</label> 
                        ...
                        <div class="form-group"> 
                            <label
                            for="harga_beli">Harga (Rp)</label> 
                            <input type="double" class="form-control 
                            @error('harga_beli') is-invalid @enderror" id="harga_beli" value="{{old('jumlah_beli')}}"                            placeholder="Masukan Harga" name="harga_beli" value="{{old('harga_beli')}}"> 
                        ...
                        <label for="jumlah_beli">Qty</label> 
                            ...
                            placeholder="Masukkan Qty" name="jumlah_beli" value="{{old('jumlah_beli')}}"> 
                            @error('jumlah_beli') <span class="text-danger">{{$message}}</span> @enderror
                        </div> 
                        
                        <div class="form-group"> 
                            <label
                            for="sub_total_beli">Sub Total (Rp)</label> 
                            <input type="double" class="form-control 
                        ...
                        <div class="form-group"> 
                            <label
                            for="persen_margin_jual">Margin Jual (%)</label> 
                            <input type="double" class="form-control 
...
<div class="card-footer">
                                    ...
                                    <a href="{{ route('pembelian.index') }}" class="btn btn-success">Cetak Nota</a>
